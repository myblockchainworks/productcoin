...
<body>
	...
	<h1>Product Coin DApp</h1>
		...
		<div style="float:right;">
	    	<a href="myhome" class="buttontype"> Back </a>
	  	</div>
	
	  <h2>Transactions</h2> <b style="margin-left: 100px;">Name: </b> ${coinName } <b style="margin-left: 100px;">Current Balance : </b>	${coinAmount }
